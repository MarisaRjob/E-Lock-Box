    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-folder-open"></i><a href="{{ url('manager/user/view') }}">User Management</a></li>
                <li><i class="fa fa-list"></i><a href="{{ url('manager/user/view') }}">View Users</a></li>
                <li><i class="fa fa-file-text"></i><a href="{{ url('manager/user/'.$user->id.'/view') }}">{{$user->first_name.' '.$user->last_name}}</a></li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    {{-- Edit profile--}}
                    <div class="col-md-8" style="margin-top: 20px">
                        {!! Form::open(['url' => 'manager/user/'.$user->id.'/edit', 'onsubmit' => 'return check_input(this)']) !!}
