    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-plus-circle"></i><a href="{{ url('manager/case/create') }}">Create Case</a></li>
            </ol>
        </div>
    </div>

    {!! Form::open(['route' => 'manager.case.store', 'onsubmit' => 'return check_input(this)']) !!}
...
{{--                        {!! Form::text('birthday', date("m/d/Y", time()), ['id' => 'birthday_create', 'placeholder' => 'mm/dd/yyyy', 'class' => 'form-control']) !!}--}}
                ...
                <div class="form-group pull-right">
                    <a type="button" class="btn btn-default" href="{{ url('manager/case/view') }}">Cancel</a>
