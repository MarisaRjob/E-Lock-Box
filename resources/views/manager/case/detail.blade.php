        ...
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-file-text"></i><a
                            href="{{ url('/manager/case/'.$data->id.'/view') }}">{{ $youth_name1 }}</a></li>
            </ol>
        </div>
    </div>
    <!-- end nav bar -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['route' => ['manager.case.create.account', $data->id], 'onsubmit' => 'return check_input_pwd(this)']) !!}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {!! Form::open(['url' => 'manager/case/'.$data->id.'/delete']) !!}
    ...
    <div class="modal fade" style="margin-top:10%" id="uploaddocument" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => '/manager/case/upload', 'files' => 'true']) !!}
                    {{ csrf_field() }}
        ...
        <div class="modal fade" style="margin-top:10%" id="{{$doc->id}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '/manager/case/doc/'.$doc->id.'/edit', 'files' => 'true']) !!}
                        {{ csrf_field() }}
                        <div class="form-group" style="display: none; visibility: hidden">
                            {!! Form::text('id', $data->id) !!}
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a role="button" class="btn btn-danger"
                           href={{ url('/manager/case/doc/'.$doc->id.'/delete') }}>Delete</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" style="margin-top:10%" id="addworkhistory" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => '/manager/case/workhistory']) !!}
                    {{ csrf_field() }}
                    <div class="form-group" style="display: none; visibility: hidden">
                        {!! Form::text('id', $data->id) !!}
                    </div>
        ...
        <div class="modal fade" style="margin-top:10%" id="editworkhistory{{$workhistory->id}}" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '/manager/case/workhistory/'.$workhistory->id.'/edit']) !!}
                        {{ csrf_field() }}
                        <div class="form-group" style="display: none; visibility: hidden">
                            {!! Form::text('id', $data->id) !!}
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <a role="button" class="btn btn-danger"
                           href={{ url('/manager/case/workhistory/'.$workhistory->id.'/delete') }}>Delete</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" style="margin-top:10%" id="addeduhistory" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => '/manager/case/eduhistory']) !!}
                    {{ csrf_field() }}
                    <div class="form-group" style="display: none; visibility: hidden">
                        {!! Form::text('id', $data->id) !!}
                    </div>
        ...
        <div class="modal fade" style="margin-top:10%" id="editeduhistory{{$eduhistory->id}}" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '/manager/case/eduhistory/'.$eduhistory->id.'/edit']) !!}
                        {{ csrf_field() }}
                        <div class="form-group" style="display: none; visibility: hidden">
                            {!! Form::text('id', $data->id) !!}
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <a role="button" class="btn btn-danger"
                           href={{ url('/manager/case/eduhistory/'.$eduhistory->id.'/delete') }}>Delete</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" style="margin-top:10%" id="addcontact" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => '/manager/case/addcontacts']) !!}
                    {{ csrf_field() }}
                    <div class="form-group" style="display: none; visibility: hidden">
                        {!! Form::text('id', $data->id) !!}
                    </div>
        ...
        <div class="modal fade" style="margin-top:10%" id="editaddcontact{{$addcontact->id}}" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '/manager/case/addcontacts/'.$addcontact->id.'/edit']) !!}
                        {{ csrf_field() }}
                        <div class="form-group" style="display: none; visibility: hidden">
                            {!! Form::text('id', $data->id) !!}
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <a role="button" class="btn btn-danger"
                           href={{ url('/manager/case/addcontacts/'.$addcontact->id.'/delete') }}>Delete</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" style="margin-top:10%" id="editProfile" tabindex="-1"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => 'manager/case/'.$data->id.'/edit', 'onsubmit' => 'return check_input(this)']) !!}
                    <div class="form-group" style="display: none; visibility: hidden">
                        {!! Form::text('id', $data->id) !!}
                    </div>
                    <div class="form-group row">
    ...
    <div class="modal fade" style="margin-top:10%" id="addcontactinfo" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => '/manager/case/addcontactinfo']) !!}
                    {{ csrf_field() }}
                    <div class="form-group" style="display: none; visibility: hidden">
                        {!! Form::text('id', $data->id) !!}
                    </div>
                        ...
                        {{--<div class="panel-body">--}}
                            {{--<div id="myTabContent" class="tab-content">--}}
                                {{--<div class="tab-pane active" id="contact_address">--}}
                                    {{--{!! Form::open(['url' => '/manager/case/addaddress']) !!}--}}
                                    {{--{{ csrf_field() }}--}}
                                    {{--<div class="form-group" style="display: none; visibility: hidden">--}}
                                        {{--{!! Form::text('id', $data->id) !!}--}}
                                    {{--</div>--}}
                                ...
                                {{--<div class="tab-pane" id="contact_phone">--}}
                                    {{--{!! Form::open(['url' => '/manager/case/addphone']) !!}--}}
                                    {{--{{ csrf_field() }}--}}
                                    {{--<div class="form-group" style="display: none; visibility: hidden">--}}
                                        {{--{!! Form::text('id', $data->id) !!}--}}
                                    {{--</div>--}}
                                ...
                                {{--<div class="tab-pane" id="contact_email">--}}
                                    {{--{!! Form::open(['url' => '/manager/case/addemail']) !!}--}}
                                    {{--{{ csrf_field() }}--}}
                                    {{--<div class="form-group" style="display: none; visibility: hidden">--}}
                                        {{--{!! Form::text('id', $data->id) !!}--}}
                                    {{--</div>--}}
        ...
        <div class="modal fade" style="margin-top:10%" id="editaddress{{$address->id}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '/manager/case/contact/address/'.$address->id.'/edit']) !!}
                        {{ csrf_field() }}
                        <div class="form-group" style="display: none; visibility: hidden">
                            {!! Form::text('id', $data->id) !!}
                        </div>
        ...
        <div class="modal fade" style="margin-top:10%" id="editphone{{$phone->id}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '/manager/case/contact/phone/'.$phone->id.'/edit']) !!}
                        {{ csrf_field() }}
                        <div class="form-group" style="display: none; visibility: hidden">
                            {!! Form::text('id', $data->id) !!}
                        </div>
        ...
        <div class="modal fade" style="margin-top:10%" id="editemail{{$email->id}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '/manager/case/contact/email/'.$email->id.'/edit']) !!}
                        {{ csrf_field() }}
                        <div class="form-group row">
                            {{ Form::label('email', 'Email', ['class' => 'col-md-2 col-form-label control-label', 'style' => 'padding-top:7px; text-align: right']) }}
                            <div class="col-md-10">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <a role="button" class="btn btn-danger"
                           href={{ url('/manager/case/contact/address/'.$address->id.'/delete') }}>Delete</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <a role="button" class="btn btn-danger"
                           href={{ url('/manager/case/contact/phone/'.$phone->id.'/delete') }}>Delete</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <a role="button" class="btn btn-danger"
                           href={{ url('/manager/case/contact/email/'.$email->id.'/delete') }}>Delete</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" style="margin-top:10%" id="addactivity" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => '/manager/case/addactivity']) !!}
                    {{ csrf_field() }}
                    <div class="form-group row">
    ...
    <div class="modal fade" style="margin-top:10%" id="uploadAvatar" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => '/manager/case/upload/avatar', 'files' => 'true']) !!}
                    {{ csrf_field() }}
                    <div class="form-group" style="display: none; visibility: hidden">
                        {!! Form::text('id', $data->id) !!}
                    </div>
