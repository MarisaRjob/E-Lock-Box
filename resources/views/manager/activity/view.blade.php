                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        @foreach($activities as $activity)
                            ...
                            @elseif($activity->assigned == Sentinel::getUser()->id || $activity->mentioned == Sentinel::getUser()->id || $activity->creator == Sentinel::getUser()->id)
                                <tr>
                                    <td>{{$activity->subject}}</td>
                                    @if($activity->task)
                                        <td><span class="label label-success">Done</span></td>
                                    ...
                                    <td>
                                        <a class="btn btn-success"
                                           href="{{ url('manager/'. $activity->id .'/view') }}">
                                            <i class="fa fa-search-plus" style="width: 10px"></i>
                                        </a>
                                    </td>
                                </tr>
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body message">
                        ...
                        {!! Form::open(['url' => '/manager/activity/create', 'class' => 'form-horizontal']) !!}
                        {{ csrf_field() }}
